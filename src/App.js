...
import Rebut from './pages/Rebut/index.js';
...
import HistoriqueTransit from './pages/HistoriqueTransit/index.js';
import Rapports from './pages/Rapports/index.js';
      ...
      <div className='main d-flex'>
        ...
        <div className={`content ${isHideSidebarAndHeader=== true && 'full'} ${isToggleSidebar === true ? 'toggle' : ''}`}>
          <Routes>
            ...
            <Route path="/history-transit" exact={true} element={<HistoriqueTransit/>} />
            <Route path="/rebuts" exact={true} element={<Rebut/>} />
            <Route path="/rapports" exact={true} element={<Rapports/>} />
